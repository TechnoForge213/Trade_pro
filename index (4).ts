...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md p-8 relative z-10 bg-gradient-card border-border backdrop-blur-sm">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => navigate('/')}
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {isLogin ? "Welcome back! Sign in to continue" : "Create your trading account"}
          </p>
        </div>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Must be 16+ (18+ for real trading)
                </p>
              </div>
            </>
          )}
        ...
        {!isLogin && (
          <div className="mt-6 p-4 rounded-lg bg-secondary/50 border border-border">
            <p className="text-xs text-muted-foreground text-center">
              Users under 18 will get a 30-day demo account. Trading involves risk.
            </p>
          </div>
        )}
      </Card>
